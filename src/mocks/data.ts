import { News, NewsCategory, NavCategory } from '../types/news'

export const CATEGORIAS_NAV: NavCategory[] = [
  'Ao vivo',
  'Política',
  'Money',
  'Mundo',
...
export const CATEGORIAS_FILTRO: NewsCategory[] = [
  'Tecnologia',
  'Política',
  'Esportes',
  'Money',
...
export const noticias: News[] = [
  // —— Tecnologia ——
  {
    ...
    excerpt: 'A nova versão do framework React traz melhorias significativas no App Router e suporte a React 19.',
  ...
  },
  {
    ...
    excerpt: 'A biblioteca de componentes mais usada no ecossistema React anuncia nova major version.',
  ...
  },
  {
    ...
    excerpt: 'Entenda os critérios WCAG e como implementar boas práticas de a11y no seu projeto.',
  ...
  },
  {
    ...
    excerpt: 'Estudo sobre segurança e conteúdo sensível na plataforma gera debate sobre moderação.',
  ...
  },
  {
    ...
    excerpt: 'Relatório mostra aumento de produtividade em áreas como suporte e redação.',
  ...
  // —— Política ——
  {
    ...
    excerpt: 'Especialistas analisam impacto da nova legislação e prazos de implementação.',
  ...
  },
  {
    ...
    excerpt: 'Deputada do Ceará é alvo de operação e usa tornozeleira eletrônica.',
  ...
  },
  {
    ...
    excerpt: 'Texto deve ir ao plenário na próxima semana; base do governo articula apoio.',
  ...
  // —— Esportes ——
  {
    ...
    excerpt: 'Entidade recebe pedidos e analisa logística para sedes alternativas.',
  ...
  },
  {
    ...
    excerpt: 'Conmebol sorteia chaves; Flamengo e Palmeiras têm caminhos acessíveis.',
  ...
  },
  {
    ...
    excerpt: 'Comitê Olímpico anuncia concentração em etapa de altitude na Europa.',
  ...
  },
  {
    ...
    excerpt: 'Copom mantém juros; comunicado cita incertezas no cenário externo.',
  ...
  },
  {
    ...
    excerpt: 'Petrobras e Vale puxam índice; dólar recua após dados do emprego nos EUA.',
  ...
  // —— Mundo ——
  {
    ...
    excerpt: 'Processo geológico que divide o continente avança; entenda o fenômeno.',
  ...
  },
  {
    ...
    excerpt: 'Conselho de Segurança debate nova resolução; enviados relatam crise humanitária.',
  ...
  // —— Agro ——
  {
    ...
    excerpt: 'Produção nacional pode superar 150 milhões de toneladas; clima favorece colheita.',
  ...
  },
  {
    ...
    excerpt: 'Produtores investem em precisão para reduzir custos e aumentar produtividade.',
  ...
  },
  {
    ...
    excerpt: 'Exportadores brasileiros se beneficiam de câmbio e estoques baixos no exterior.',
  ...
  },
  {
    ...
    excerpt: 'Confira possíveis tendências de moda a partir dos looks das celebridades.',
